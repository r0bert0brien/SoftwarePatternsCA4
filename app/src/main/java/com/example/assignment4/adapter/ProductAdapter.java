...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        if (isAdmin) {
            bindAdminProduct(holder, product, position);
        } else {
            bindUserProduct(holder, product);
        }
    }

    private void bindAdminProduct(ProductViewHolder holder, Product product, int position) {
        Log.d(TAG, "Choosing Admin!");
    ...
    private void bindUserProduct(ProductViewHolder holder, Product product) {
